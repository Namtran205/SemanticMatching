          ...
          <>
            ...
            <section className="lc-hero">
              ...
              <h1 className="lc-hero-title">
                Minh họa Semantic Matching<br />
                <span className="lc-hero-accent">Văn bản Pháp lý</span>
              </h1>
              <p className="lc-hero-sub">
                Kiến trúc Hybrid Search kết hợp Cross-Encoder. Tìm kiếm và xếp hạng (Reranking) các đoạn văn có ý nghĩa tương đương giữa 2 tài liệu.
              </p>
            </section>
            ...
            <div className="lc-features">
              {[
                { icon: '🔍', title: 'Hybrid Search', desc: 'Tìm kiếm kết hợp Vector (Dense) và BM25 (Sparse)' },
                { icon: '🎯', title: 'Cross-Encoder Reranking', desc: 'Sắp xếp lại độ liên quan ngữ nghĩa độ chính xác cao' },
                { icon: '📄', title: 'Semantic Matching', desc: 'Khớp các đoạn văn bản pháp lý tương đồng' },
                { icon: '🔒', title: 'Local AI', desc: 'Mô hình nhúng và reranking chạy hoàn toàn cục bộ' },
              ].map((f, i) => (
        ...
        <div className="lc-overlay">
          <div className="lc-overlay-card">
            ...
            <h3 className="lc-overlay-title">
              {comparing ? 'Đang truy xuất & Reranking...' : 'Đang xử lý file...'}
            </h3>
            <p className="lc-overlay-desc">
              {comparing
                ? 'Sử dụng Hybrid Search và Cross-Encoder để tìm đoạn văn tương đồng...'
